      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-6 mb-6">
          ...
          <div className="space-y-4 md:max-w-[280px] lg:max-w-[320px] shrink-0">
            ...
            <p className="text-gray-400 leading-relaxed text-sm sm:text-[15px] font-medium">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:contents">
            ...
            <div className="space-y-4 md:max-w-[260px] shrink-0">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-2 sm:gap-4 text-gray-400">
                ...
                <li className="flex items-start gap-2 sm:gap-4 text-gray-400 min-w-0">
                ...
                <li className="flex items-center gap-2 sm:gap-4 text-gray-400">
